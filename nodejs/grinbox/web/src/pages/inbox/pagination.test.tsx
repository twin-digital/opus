...
import { Pagination, displayFrom } from './list'
...
describe('Pagination', () => {
  ...
  it('clamps the last window to total and shows last page boundaries', () => {
    ...
    render(<Pagination offset={125} limit={25} total={130} onPage={() => {}} />)
  ...
  it('shows 0–0 of 0 and a single page when empty', () => {
    render(<Pagination offset={0} limit={25} total={0} onPage={() => {}} />)
    expect(screen.getByText('Page 1 of 1')).toBeInTheDocument()
    expect(screen.getByText('0–0 of 0')).toBeInTheDocument()
  })

  it('disables Previous on the first page and Next on the last', () => {
    render(<Pagination offset={0} limit={25} total={130} onPage={() => {}} />)
