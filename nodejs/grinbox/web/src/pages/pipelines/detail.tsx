import type { OperatorDetail, PipelineDetail, TagKeyRegistryEntry } from '@grinbox/server'
...
function OperatorRow({ operator, pipelineId }: { operator: OperatorDetail; pipelineId: number }) {
  const meta = operatorTypeFor(operator.type_key)
