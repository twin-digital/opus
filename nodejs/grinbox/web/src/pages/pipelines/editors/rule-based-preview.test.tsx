import type { RuleBasedTaggerConfig } from '@grinbox/shared'
...
import { type RuleBasedDraft, RuleBasedPreview } from './rule-based-editor'
  ...
  it('surfaces an invalid_match_expression error inline', async () => {
    useOperatorPreview.mockReturnValue(
      queryStub(undefined, {
        isPending: false,
        isError: true,
        error: new ApiError('invalid_match_expression', 'Unknown function "contians" in match expression'),
      }),
    )
    renderEditor(validDraft)
