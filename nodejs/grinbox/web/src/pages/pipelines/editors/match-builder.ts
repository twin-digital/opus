import { MATCH_FIELD_PREFIXES, MATCH_MESSAGE_FIELDS, MATCH_OPERATORS } from '@grinbox/shared'
 ...
 *
 * The field/operator vocabularies are taken from `@grinbox/shared` so the
