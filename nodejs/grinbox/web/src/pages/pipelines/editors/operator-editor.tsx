import { type OperatorTypeKey, operatorConfigSchemas } from '@grinbox/shared'
...
import { OPERATOR_TYPE_BY_KEY, blankConfigFor } from '../operator-types'
import {
  ApplyCategoryEditor,
...
function TypeEditor({
  ...
  // The draft arrives as `unknown` because the dialog holds one config for
  // whichever type is selected; the type key is what narrows it, and the schema
  // for that key is what validates it on save.
  switch (typeKey) {
    case 'llm_tagger':
