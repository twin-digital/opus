 ...
 *  - `push_suppressed`:      `{ kind, deferred_to_triage_id, deferred_to_operator_id }`
...
export interface ResourceEvent {
  readonly event_type: 'resource_op_succeeded' | 'resource_op_limited' | 'resource_op_failed' | 'push_suppressed'
