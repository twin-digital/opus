/**
 * `@grinbox/server` library surface. Importing this barrel has NO side effects —
...
// `type { ApiRoutes }` from `@grinbox/server` and builds a typed Hono RPC
...
export type { ModelOption } from './http/api/models.js'
