 ...
 * (`@grinbox/shared`). The parser itself is dependency-free of server types and
...
import { type CompiledMatch, type FieldLookup, MatchExpressionError, compileMatch } from '@grinbox/shared'
