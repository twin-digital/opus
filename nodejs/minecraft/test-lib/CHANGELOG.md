...
- dae3cba: `minecraft:type_family` behaves: `getTypeFamilies()` returns the tokens a test seeded on that
...
- b542185: `EntityTypes` behaves: it reads a type catalog belonging to the fake server that handed it out, and
