...
`vacation_home` availability limitation both match the vendor docs verbatim. The Escapia 25+ unit
...
| Cloudbeds  | ✅ Candidate         | Custom pricing; hotel-oriented but serves STRs. Most automated Lynx integration of the group.                                                                                                                          |
