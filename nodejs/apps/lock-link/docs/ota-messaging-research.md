...
Compiled 2026-07-10 via multi-source research with adversarial verification (every claim below
survived a 3-source verification pass; quotes were checked verbatim against the live vendor
pages). Supports the OTA due-diligence section of [proposal.md](./proposal.md). Separates
**vendor-documented** facts from **industry-reported** behavior.
