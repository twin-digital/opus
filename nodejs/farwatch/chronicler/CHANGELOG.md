...
- 0bd0179: fix(deps): update all non-major dependencies
...
- a238fe3: feat(farwatch): the chronicler's dice-free view carries goals and per-trial resource movements.
